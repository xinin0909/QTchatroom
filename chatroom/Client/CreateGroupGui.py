...
class CreateGroupGui(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # 设置标题
        self.setWindowTitle(self.tr("创建群"))
    ...
    def initUI(self):
        ...
        infoLabel.setGeometry(QRect(90, 5, 350, 70))
        infoLabel.setFont(QFont("微软雅黑", 20, 50))
        infoLabel.setText(self.tr("请输入要创建群的名称"))
    ...
    def setButtonClicked(self):
        ...
        if group_name == "":
            ...
            QMessageBox.information(self, self.tr("成功"), self.tr("创建成功！"))
            self.close()
